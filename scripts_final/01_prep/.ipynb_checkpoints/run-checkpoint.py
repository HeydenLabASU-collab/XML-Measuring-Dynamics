...
reference = f"/scratch/masauer2/Regeneron_USample_Compare/VGSDWRFLRGYHQYQ/00_system_prep/prot.gro"
trajectory = f"/scratch/masauer2/Regeneron_USample_Compare/VGSDWRFLRGYHQYQ/03_100ns/sample-NPT_pbc.trr"
